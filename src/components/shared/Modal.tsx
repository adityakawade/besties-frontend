...
const Modal: FC<ModalInterface> = ({ open = true, onClose, title = "Modal Title", children = "Modal Description goes here" }) => {
    return (
        <>
            {
                open &&
                ...
                <div className='h-screen flex  justify-center  items-center bg-black/90  fixed top-0 left-0 w-full animate__animated animate__fadeIn '>
